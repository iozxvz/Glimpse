...
@property (nonatomic, weak) UIView *recodingView;
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _viewSize = CGSizeMake(_viewSize.width, _viewSize.height);
    ...
    dispatch_async(_render_queue, ^{
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            UIGraphicsPushContext(bitmapContext); {
                [self->_recodingView drawViewHierarchyInRect:CGRectMake(0, 0, self->_viewSize.width, self->_viewSize.height) afterScreenUpdates:NO];
